  ...
  const guests = [
    {
     img: "https://res.cloudinary.com/di40y80dw/image/upload/v1709103485/Instagram_post_-_559_1_1_wevg3x.png",
      ...
      content: "Suresh Abaji Khopade (born 1 June 1951) is an Indian writer and a retired Indian Police Service (IPS) officer. He is a pioneer of community policing initiatives in the state of Maharashtra. He is well known for safeguarding then hyper-sensitive town Bhiwandi during the 1992 communal Riots.",
    },
    {
      ...
      content: "Suresh Prabhakar Prabhu (born 11 July 1953) is an Indian politician and the Chancellor of Rishihood University.He is also a visiting professor at the London School of Economics",
    },
    {
      ...
      content: "The Co-Founder and Group President of Just Dial – India's largest local business search engine. Having successfully established Just Dial in 1997 , Krishnan has emerged as a renowned angel investor, mentor and entrepreneur in the country.",
    },
    {
      ...
      content: "Part of a highly skilled, capable and motivated team of dynamic professionals delivering entire plants/equipment/end-end services/O&M for Power, Mining, Cement and Sugar industries world wide.",
    },
    // {
    ...
    // },
    {
      ...
      content: "Chinu Kala is an entrepreneur, socialite, model and one of the prominent women in the fashion jewellery business in India today.Her startup Rubans Accessories, founded in 2014, is the fastest-growing fashion jewellery brand in India",
    },
    {
...

    {
      ...
      content: "a BITS Pilani Goa graduate, co-founded 2 startups, and have experience in the ed tech industry. Developed a deep passion for finance and global equity and derivative markets and trade regularly.",
    },
    {
      ...
      whoIsHe: "Co-Founder, Bluelearn",
      content: "Building BlueLearn and helping tier-2,3 college students get benefits of top colleges.BlueLearn has more than 200k members and every 10mins, a new member joins in",
    },
    {
      ...
      content: "Sanjay Sethi (born 27 June 1972) is a mechanical engineer and Internet entrepreneur.In 2011, he co-founded ShopClues, a Gurgaon-based online marketplace for unbranded goods.",
    },
    // {
    ...
    // },
    {
      ...
      content: "Abhishek Kar has trained more than 15000 students so far with his training initiatives. Imbued ith a firm belief that ‘merely existing is not Living’, Abhishek Kar has been working hard to prove that nothing is impossible",
    },
    // {
    ...
    // },
    {
      ...
      // whoIsHe2: "Founder, Hasley India",
      content: "Sushant Bindal is the founder of Money Monitors Pvt Ltd. He has been trading in the markets for more than 3 years. He is a stock market trainer and runs an Investment Advisory firm and two other companies offering real estate and corporate lending services.",
    },
    {
      ...
      // whoIsHe2: "Founder, Hasley India",
      content: "Kushal Lodha is the founder of KAGR, an Education platform in Finance Upskilling. the Venture Capital arm of Aditya Birla Group. Prior to that, he was an EA to the Chief Economist of Aditya Birla Group.",
    },
    {
    ...
    },
    {
      ...
      name: "RJ Soham",
      whoIsHe: "Content Creator",
      content: "Soham Shahane is one of the leading marathi creators.He is the founder of Cryptexa Analytics, a dynamic digital marketing agency specializing in marketing strategy, AI integration, brand development, and content production.",
    },
